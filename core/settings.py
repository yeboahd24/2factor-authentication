...
DEBUG = True
SECRET_KEY = 't^kk9qi_-mbyszoee+hcbgxj=v!aehw!x(s5bp9ecuin+8l$)@'
...
LOCALL_APPS = ['user']
EXTERNAL_APPS = ['corsheaders', 'drf_spectacular', 'rest_framework']

INSTALLED_APPS += LOCALL_APPS + EXTERNAL_APPS
...
SPECTACULAR_SETTINGS = {
    ...
    'CONTACT': {'name': 'Dominic', 'email': 'yeboahd24gmail.com'},
    'OAUTH2_FLOWS': [],
